      ...
      <div className="pl-20">
        ...
        <div className="mb-4 ">
          ...
          <div className="flex items-center">
            <input 
            required
            className="mt-1 block w-10/12 px-4 pl-3 pr-10 py-2  border-gray-300 focus:outline-none  focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md"></input>
          </div>
        </div>
        ...
        <div className="mb-4 ">
          <label className="block  font-semibold text-gray-700">
            Cantidad de Paquetes <select className="text-red-500">*</select>
          </label>
          <div className="flex items-center">
