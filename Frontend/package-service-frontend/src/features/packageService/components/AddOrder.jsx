  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const packagePromises = orderForm.packages.map((pkg) =>
        createPackages(orderId, pkg.weight) // Asegúrate de que createPackages toma el orderId y el weight del paquete
      );
      // Esperar a que todas las promesas de creación de paquetes se completen
