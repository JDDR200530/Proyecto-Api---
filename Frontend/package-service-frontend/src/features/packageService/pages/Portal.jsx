...
export const Portal = () => {
    ...
    const handleSearch = () => {
        if (orderId.trim()) {
            // Buscar por ID
            navigate(`/findorders/${orderId.trim()}`);
        } else if (clientName.trim()) {
            // Buscar por nombre
            navigate(`/findnames/${clientName.trim()}`);
        }
    };
                ...
                <div className="p-4">
                    ...
                    <div className="pr-6 py-4">
                        <div className="justify-between flex">
                            ...
                            <input
                                className="bg-orange-100 rounded-sm focus:outline"
                                value={orderId}
                                onChange={(e) => {
                        ...
                        <div className="justify-between flex">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    setOrderId(""); // Limpiar el ID de orden
                                }}
                            />
                        </div>
                    </div>
                    <div
                        ...
                        className="bg-orange-500 hover:bg-green-700 text-white font-bold rounded w-max mt-2 p-4 shadow-sm cursor-pointer"
                    >
                        Buscar
                    </div>
                </div>
